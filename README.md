...
| Automation service | ✅ Ada (Dummy scheduler) |
...
├── services/                # Firebase Auth, InfluxDB, storage, automation
...
Schedule adalah tab utama untuk mengkonfigurasi waktu belajar mengajar kelas secara mingguan.

Aturan automation:

```txt
15 menit sebelum kelas mulai
└── Pre-start automation (Lampu ON, AC ON)

Saat kelas selesai
└── Cek presence
    ├── Kosong    -> shutdown
    ├── Masih ada -> waiting empty
